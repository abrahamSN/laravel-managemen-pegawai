...
@section('content')
    ...
    <div class="box box-info">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form class="form-horizontal" id="form_validation" action="{{ url('/role/update',$show->id)}}" method="POST">
            {{ csrf_field() }}
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="description" id="description" required value="{{ $show->description }}" placeholder="Description">
            ...
            <div class="box-footer">
                <a href="{{ url('/role') }}" class="btn btn-default">Batal</a>
